...
export class Web3RSVP__eventCollectionResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class Web3RSVP extends ethereum.SmartContract {
  ...
  eventCollection(param0: Bytes): Web3RSVP__eventCollectionResult {
    let result = super.call(
      "eventCollection",
      "eventCollection(bytes32):(bytes32,string,address,uint256,uint256,uint256,bool)",
      [ethereum.Value.fromFixedBytes(param0)]
    );

    return new Web3RSVP__eventCollectionResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_eventCollection(
    param0: Bytes
  ): ethereum.CallResult<Web3RSVP__eventCollectionResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Web3RSVP__eventCollectionResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toAddress(),
        value[3].toBigInt(),
